...
{
    int field1;
    int (*method)(struct mystruct self, int);
    int (*method2)(struct mystruct self, int);
} mystruct;
...
{
# 279 "test.c"
    mystruct s = {. 10 = 10, .method = &return_field, .method2 = &return_int };
    printf("%d\n%d\n%s\n%s\n", s.method(s, 2), s.method2(s, 2), "typeof(int (struct mystruct self))", "typeof(typeof(int (struct mystruct self))*)");
    return 0;
